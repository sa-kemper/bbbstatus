...
-- +goose Down
DROP INDEX idx_poll_responses_poll_id;
DROP INDEX idx_user_events_internal_meeting_id;
DROP INDEX idx_chat_messages_internal_meeting_id;
DROP INDEX idx_polls_internal_meeting_id;
DROP INDEX idx_meetings_external_id;
DROP INDEX idx_chat_messages_meeting_time;
DROP INDEX idx_polls_meeting;
